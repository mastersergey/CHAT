...
})({"aK2Zg":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _formActionsJs = require("./formActions.js");
var _loadJs = require("./load.js");
var _networkJs = require("./network.js");
document.addEventListener('DOMContentLoaded', _loadJs.init);
_viewJs.chatSpaceWrapper.addEventListener('scroll', _loadJs.loadOnScroll);
_viewJs.MODALS.ACCEPT.FORM.addEventListener('submit', _formActionsJs.saveToken);
_viewJs.MODALS.SETTINGS.FORM.addEventListener('submit', _formActionsJs.setUsername);
_viewJs.MODALS.AUTHORIZATION.FORM.addEventListener('submit', _formActionsJs.codeResponse);
_networkJs.connectSocket.addEventListener('message', _networkJs.getMessage);
_viewJs.FORM.CURRENT.addEventListener('submit', _formActionsJs.postMessage);
_viewJs.MODALS.ACCEPT.OPEN_BUTTON.addEventListener('click', _viewJs.MODALS.OPEN);
_viewJs.MODALS.SETTINGS.OPEN_BUTTON.addEventListener('click', _viewJs.MODALS.OPEN);
_viewJs.MODALS.AUTHORIZATION.OPEN_BUTTON.addEventListener('click', _viewJs.MODALS.OPEN);
_viewJs.MODALS.SETTINGS.MODAL.addEventListener('click', _viewJs.MODALS.CLOSE);
_viewJs.MODALS.AUTHORIZATION.MODAL.addEventListener('click', _viewJs.MODALS.CLOSE);

},{"./view.js":"2GA9o","./formActions.js":"kbJaJ","./load.js":"jOeeP","./network.js":"hJPj8"}],"2GA9o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MODALS", ()=>MODALS
);
parcelHelpers.export(exports, "chatSpace", ()=>chatSpace
);
parcelHelpers.export(exports, "chatSpaceWrapper", ()=>chatSpaceWrapper
);
parcelHelpers.export(exports, "FORM", ()=>FORM
);
parcelHelpers.export(exports, "MESSAGE_TEMPLATES", ()=>MESSAGE_TEMPLATES
);
...
const MODALS = {
    ...
    OPEN (event) {
        ...
        if (isSettingsButton) MODALS.SETTINGS.MODAL.classList.add('settings__active');
            ...
            } else MODALS.AUTHORIZATION.MODAL.classList.add('authorization__active');
        } else if (isAcceptButton) MODALS.ACCEPT.MODAL.classList.add('accept__active');
    },
    CLOSE (event) {
        ...
        if (isSettingsModal) MODALS.SETTINGS.MODAL.classList.remove('settings__active');
...
const chatSpace = document.querySelector('.chat__space');
const chatSpaceWrapper = document.querySelector('.wrapper');
const FORM = {
...
},{"js-cookie":"c8bBu","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"c8bBu":[function(require,module,exports) {
...
},{}],"k1fIT":[function(require,module,exports) {
...
},{}],"kbJaJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "codeResponse", ()=>codeResponse
);
var _viewJs = require("./view.js");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
...
function postMessage(event) {
    event.preventDefault();
    const input = _viewJs.FORM.INPUT;
    if (!input.value) return;
    _networkJs.SOCKET.sendMessage(input.value);
    input.value = '';
}
function codeResponse(event) {
    event.preventDefault();
    const input = _viewJs.MODALS.AUTHORIZATION.INPUT;
    _networkJs.postEmail(input.value);
    input.value = '';
    _viewJs.MODALS.AUTHORIZATION.MODAL.classList.toggle('authorization__active');
    _viewJs.MODALS.ACCEPT.MODAL.classList.toggle('accept__active');
}
function saveToken(event) {
    event.preventDefault();
    const input = _viewJs.MODALS.ACCEPT.INPUT;
    _jsCookieDefault.default.set('token', input.value, {
        expires: 30
    });
    _networkJs.emailResponse(input.value);
    _loadJs.loadMessageHistory();
    _viewJs.MODALS.ACCEPT.MODAL.classList.toggle('accept__active');
}
function setUsername(event) {
    event.preventDefault();
    const input = _viewJs.MODALS.SETTINGS.INPUT;
    const username = input.value;
    _networkJs.patchUsername(username, _networkJs.token);
}

},{"./view.js":"2GA9o","js-cookie":"c8bBu","./network.js":"hJPj8","./load.js":"jOeeP","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"hJPj8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postEmail", ()=>postEmail
);
parcelHelpers.export(exports, "patchUsername", ()=>patchUsername
);
parcelHelpers.export(exports, "getMessage", ()=>getMessage
);
parcelHelpers.export(exports, "emailResponse", ()=>emailResponse
);
...
const token = _jsCookieDefault.default.get('token');
const currentUserEmail = _jsCookieDefault.default.get('email');
const connectSocket = new _reconnectingWebsocketDefault.default(`${URL.WEBSOCKET}?${token}`);
const SOCKET = {
    sendMessage (message) {
...
function getMessage(event) {
    ...
    const date = _dateFns.format(new Date(data.createdAt), 'kk:mm');
    const isCurrentUserMessage = data.user.email === currentUserEmail;
    const template = isCurrentUserMessage ? _viewJs.MESSAGE_TEMPLATES.POST : _viewJs.MESSAGE_TEMPLATES.GET;
    const message = new _messageJs.Message(template, text, date, userName);
    message.createMessage();
    _viewJs.chatSpace.append(message.template);
    if (isCurrentUserMessage) _viewJs.chatSpace.scrollIntoView(false);
}
...
async function emailResponse(token1) {
    try {
        ...
        if (userEmail) _jsCookieDefault.default.set('email', userEmail, {
            expires: 30
        });
        else throw new _errorJs.EmailError('Не удалось получить почту');
    } catch (e) {
        alert(`${e.name}:${e.text}`);
    }
}
function patchUsername(username, token2) {
    try {
        fetch(URL.USER, {
            method: 'PATCH',
            headers: {
...
},{"js-cookie":"c8bBu","date-fns":"9yHCA","reconnecting-websocket":"foTU5","./view.js":"2GA9o","./message.js":"lGCpb","./error.js":"9ndDx","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/toInteger/index.js":"f7kKX","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"f7kKX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"fsust":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"9wUgQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"lnm6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../isDate/index.js":"kqNhT","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"kqNhT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/requiredArgs/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"8XKCq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./_lib/formatDistance/index.js":"lLrcE","./_lib/formatLong/index.js":"cA6Xb","./_lib/formatRelative/index.js":"9QlMp","./_lib/localize/index.js":"jv1Fa","./_lib/match/index.js":"1wA2o","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"lLrcE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"cA6Xb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildFormatLongFn/index.js":"h1FGd","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"h1FGd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"9QlMp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"jv1Fa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildLocalizeFn/index.js":"5l2rZ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"5l2rZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"1wA2o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildMatchFn/index.js":"2nEf9","../../../_lib/buildMatchPatternFn/index.js":"4GjCS","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"2nEf9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"4GjCS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"lL2M9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/toInteger/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../_lib/toInteger/index.js":"f7kKX","../addMilliseconds/index.js":"7Tp9s","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"3cYKM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"4nEkI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../startOfUTCISOWeek/index.js":"3ta4C","../startOfUTCISOWeekYear/index.js":"4u8O6","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"3ta4C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"4u8O6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCISOWeekYear/index.js":"03QaQ","../startOfUTCISOWeek/index.js":"3ta4C","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"03QaQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../startOfUTCISOWeek/index.js":"3ta4C","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"b7GgV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../startOfUTCWeek/index.js":"dDZbE","../startOfUTCWeekYear/index.js":"bJAVl","../requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"dDZbE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../toInteger/index.js":"f7kKX","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"bJAVl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCWeekYear/index.js":"8i6st","../requiredArgs/index.js":"9wUgQ","../startOfUTCWeek/index.js":"dDZbE","../toInteger/index.js":"f7kKX","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"8i6st":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"fsust","../requiredArgs/index.js":"9wUgQ","../startOfUTCWeek/index.js":"dDZbE","../toInteger/index.js":"f7kKX","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"6pP6x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"9oZiA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../addLeadingZeros/index.js":"6pP6x","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"1ztit":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"bc74C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"4R0Xq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"iOhcx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"foTU5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*! *****************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"lGCpb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"9ndDx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}],"jOeeP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadOnScroll", ()=>loadOnScroll
);
parcelHelpers.export(exports, "init", ()=>init
);
parcelHelpers.export(exports, "loadMessageHistory", ()=>loadMessageHistory
);
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _viewJs = require("./view.js");
...
async function loadMessageHistory() {
    ...
    const response = await fetch(url, {
        method: 'GET',
        headers: {
            'Authorization': `Bearer ${_networkJs.token}`
        }
    });
    const history = await response.json();
    const messages = history.messages;
    for (let item of messages)_messageJs.MESSAGE.STORAGE.push(item);
    _messageJs.MESSAGE.STORAGE.reverse();
    renderMessageHistory();
    _viewJs.chatSpace.scrollIntoView(false);
}
function init() {
    const isUserAuthorized = !!_networkJs.token;
    _viewJs.MODALS.AUTHORIZATION.OPEN_BUTTON.textContent = isUserAuthorized ? 'Выйти' : 'Войти';
    if (isUserAuthorized) loadMessageHistory();
    else _viewJs.MODALS.AUTHORIZATION.MODAL.classList.add('authorization__active');
}
function renderMessageHistory(storage = _messageJs.MESSAGE.STORAGE, start = _messageJs.MESSAGE.START, end = _messageJs.MESSAGE.COUNT) {
    if (_messageJs.MESSAGE.COUNT >= _messageJs.MESSAGE.STORAGE.length) return;
    for(let message = start; message < end; message++){
        const messageText = storage[message].text;
        const messageTime = _formatDefault.default(new Date(storage[message].createdAt), 'kk:mm');
        const name = storage[message].user.name;
        const email = storage[message].user.email;
        const isCurrentUserMessage = email === _networkJs.currentUserEmail;
        const template = isCurrentUserMessage ? _viewJs.MESSAGE_TEMPLATES.POST.cloneNode(true) : _viewJs.MESSAGE_TEMPLATES.GET.cloneNode(true);
        ...
        _viewJs.chatSpace.prepend(template);
    }
    _messageJs.MESSAGE.START += 20;
    _messageJs.MESSAGE.COUNT += 20;
}
function loadOnScroll() {
    if (_viewJs.chatSpaceWrapper.scrollTop === 0) {
        const currentHeigth = _viewJs.chatSpace.offsetHeight;
        renderMessageHistory();
        _viewJs.chatSpaceWrapper.scrollTop = _viewJs.chatSpace.offsetHeight - currentHeigth;
        if (_messageJs.MESSAGE.COUNT >= _messageJs.MESSAGE.STORAGE.length) alert('Вся история загружена');
    }
}

},{"js-cookie":"c8bBu","./view.js":"2GA9o","./message.js":"lGCpb","date-fns/format":"lnm6V","./network.js":"hJPj8","@parcel/transformer-js/src/esmodule-helpers.js":"k1fIT"}]},["aK2Zg","bDbGG"], "bDbGG", "parcelRequire94c2")
